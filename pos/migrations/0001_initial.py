    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update_date', models.DateTimeField(auto_now=True, null=True, verbose_name='Last Update Date')),
                ('customer_name', models.CharField(max_length=75)),
                ('created_by', models.ForeignKey(db_column='created_by', default=1, editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('last_updated_by', models.ForeignKey(db_column='last_updated_by', default=1, editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='MXN', max_digits=10)),
                ('quantity', models.PositiveSmallIntegerField()),
                ('created_by', models.ForeignKey(db_column='created_by', default=1, editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('last_updated_by', models.ForeignKey(db_column='last_updated_by', default=1, editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='pos.order')),
